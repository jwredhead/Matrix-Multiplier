...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock dataa datab overflow result
//VERSION_BEGIN 18.1 cbx_altbarrel_shift 2019:04:11:16:04:12:SJ cbx_altfp_add_sub 2019:04:11:16:04:12:SJ cbx_altpriority_encoder 2019:04:11:16:04:12:SJ cbx_cycloneii 2019:04:11:16:04:12:SJ cbx_lpm_add_sub 2019:04:11:16:04:12:SJ cbx_lpm_compare 2019:04:11:16:04:12:SJ cbx_mgl 2019:04:11:16:07:46:SJ cbx_nadder 2019:04:11:16:04:12:SJ cbx_stratix 2019:04:11:16:04:12:SJ cbx_stratixii 2019:04:11:16:04:12:SJ  VERSION_END
...
module  FP_Adder_altbarrel_shift_35e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FP_Adder_altbarrel_shift_35e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_Adder_altbarrel_shift_olb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //FP_Adder_altbarrel_shift_olb
...
module  FP_Adder_altpriority_encoder_6e8
	...
	FP_Adder_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	FP_Adder_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[3:2]),
...
module  FP_Adder_altpriority_encoder_be8
	...
	FP_Adder_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	FP_Adder_altpriority_encoder_6e8   altpriority_encoder12
	( 
	.data(data[7:4]),
...
module  FP_Adder_altpriority_encoder_6v7
	...
	FP_Adder_altpriority_encoder_3v7   altpriority_encoder17
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder17_q));
	FP_Adder_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[3:2]),
...
module  FP_Adder_altpriority_encoder_bv7
	...
	FP_Adder_altpriority_encoder_6v7   altpriority_encoder15
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder15_q));
	FP_Adder_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[7:4]),
...
module  FP_Adder_altpriority_encoder_r08
	...
	FP_Adder_altpriority_encoder_be8   altpriority_encoder10
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	FP_Adder_altpriority_encoder_bv7   altpriority_encoder9
	( 
	.data(data[7:0]),
...
module  FP_Adder_altpriority_encoder_rf8
	...
	FP_Adder_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder19_q),
	.zero(wire_altpriority_encoder19_zero));
	FP_Adder_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[15:8]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_Adder_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	FP_Adder_altpriority_encoder_r08   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	FP_Adder_altpriority_encoder_rf8   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //FP_Adder_altpriority_encoder_qb6
...
module  FP_Adder_altpriority_encoder_qh8
	...
	FP_Adder_altpriority_encoder_nh8   altpriority_encoder27
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	FP_Adder_altpriority_encoder_nh8   altpriority_encoder28
	( 
	.data(data[3:2]),
...
module  FP_Adder_altpriority_encoder_vh8
	...
	FP_Adder_altpriority_encoder_qh8   altpriority_encoder25
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder25_q),
	.zero(wire_altpriority_encoder25_zero));
	FP_Adder_altpriority_encoder_qh8   altpriority_encoder26
	( 
	.data(data[7:4]),
...
module  FP_Adder_altpriority_encoder_fj8
	...
	FP_Adder_altpriority_encoder_vh8   altpriority_encoder23
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	FP_Adder_altpriority_encoder_vh8   altpriority_encoder24
	( 
	.data(data[15:8]),
...
module  FP_Adder_altpriority_encoder_q28
	...
	FP_Adder_altpriority_encoder_n28   altpriority_encoder34
	( 
	.data(data[3:2]),
...
module  FP_Adder_altpriority_encoder_v28
	...
	FP_Adder_altpriority_encoder_q28   altpriority_encoder32
	( 
	.data(data[7:4]),
...
module  FP_Adder_altpriority_encoder_f48
	...
	FP_Adder_altpriority_encoder_v28   altpriority_encoder30
	( 
	.data(data[15:8]),
...
module  FP_Adder_altpriority_encoder_e48
	...
	FP_Adder_altpriority_encoder_fj8   altpriority_encoder21
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	FP_Adder_altpriority_encoder_f48   altpriority_encoder22
	( 
	.data(data[31:16]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_Adder_altfp_add_sub_5mk
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	FP_Adder_altbarrel_shift_35e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	FP_Adder_altbarrel_shift_olb   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	FP_Adder_altpriority_encoder_qb6   leading_zeroes_cnt
	( 
	.data({man_add_sub_res_mag_dffe21_wo[25:1], 1'b1, {6{1'b0}}}),
	.q(wire_leading_zeroes_cnt_q));
	FP_Adder_altpriority_encoder_e48   trailing_zeros_cnt
	( 
...
endmodule //FP_Adder_altfp_add_sub_5mk
//VALID FILE
...
module FP_Adder (
	...
	FP_Adder_altfp_add_sub_5mk	FP_Adder_altfp_add_sub_5mk_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
